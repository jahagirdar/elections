...
While there was a strong anti-incumbancy current, and as per some reports the winning margin for BJP was 1% or less indicating a closely fought elections, It is not clear what led to the vote swing in some seats and not in another

* Projects was not an issue. Retaining wards and flipping wards had the same project spread.
* Project amount was not an issue. We saw the same statistics for boht the retaining and flipping wards.
